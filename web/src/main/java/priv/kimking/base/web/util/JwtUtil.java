package priv.kimking.base.web.util;
...
public class JwtUtil {
    ...
    // 创建token
    public static String createToken(String username, List<String> roleIds, String secret, boolean rememberMe) {
