 ...
 * @date 2021/11/4
 */
public class GenSum extends ClassLoader {
    ...
    public static void main(String[] args) throws Exception {
        ...
        outputClazz(bytes);
        // 加载AsmHelloWorld
        Class<?> clazz = new GenSum().defineClass("priv.kimking.base.bytecode.asm.AsmSumOfTwo", bytes, 0, bytes.length);
        // 反射获取 main 方法
    ...
    private static byte[] generate() {
        ...
        classWriter.visit(Opcodes.V1_7, Opcodes.ACC_PUBLIC, "priv/kimking/base/bytecode/asm/AsmSumOfTwo", null, "java/lang/Object", null);
        ...
        methodVisitor.visitTypeInsn(Opcodes.NEW, "priv/kimking/base/bytecode/asm/AsmSumOfTwo");
        methodVisitor.visitInsn(Opcodes.DUP);
        methodVisitor.visitMethodInsn(Opcodes.INVOKESPECIAL, "priv/kimking/base/bytecode/asm/AsmSumOfTwo", "<init>", "()V", false);
        methodVisitor.visitInsn(Opcodes.ICONST_1);
        methodVisitor.visitInsn(Opcodes.ICONST_2);
        methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "priv/kimking/base/bytecode/asm/AsmSumOfTwo", "sum", "(II)I", false);
